...
class _DashboardDoctorState extends State<DashboardDoctor> {
  ...
  Widget build(BuildContext context) {
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Resumen clínico', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 8),
                      Row(
                        children: [
                          _summaryChip('Pacientes', provider.pacientesDoctor.length.toString()),
                          const SizedBox(width: 8),
                          _summaryChip('Solicitudes', provider.solicitudesDoctor.length.toString()),
                          const SizedBox(width: 8),
                          _summaryChip('Citas', provider.citasDoctor.length.toString()),
                        ],
                      ),
                    ],
                  ),
    ...
    return Scaffold(
      ...
      drawer: AppDrawer(currentRole: authProvider.userRole, currentUserName: authProvider.userName),
      body: content,
    );
  }
