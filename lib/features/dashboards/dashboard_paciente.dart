...
import '../diagnostico/historial_diagnosticos.dart';
import '../diagnostico/subir_imagen.dart';

class DashboardPaciente extends StatefulWidget {
  final bool showScaffold;
  final VoidCallback? onOpenSubirImagen;
  final VoidCallback? onOpenHistorial;

  const DashboardPaciente({
    super.key,
    this.showScaffold = true,
    this.onOpenSubirImagen,
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildActionCard(
            ...
            onPressed: () {
              if (widget.onOpenSubirImagen != null) {
                widget.onOpenSubirImagen!();
                return;
              }
