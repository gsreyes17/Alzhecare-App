...
class GestionUsuariosAdmin extends StatefulWidget {
  final bool showScaffold;

  const GestionUsuariosAdmin({super.key, this.showScaffold = true});

  @override
  State<GestionUsuariosAdmin> createState() => _GestionUsuariosAdminState();
}

class _GestionUsuariosAdminState extends State<GestionUsuariosAdmin> {
              ...
              children: [
                ...
                if (_canEditRole)
                  DropdownButtonFormField<String>(
                    initialValue: (_role == UserRole.doctor || _role == UserRole.admin) ? _role : UserRole.doctor,
